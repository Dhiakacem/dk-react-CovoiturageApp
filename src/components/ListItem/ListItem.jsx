        ...
        <Link to="/" key={item.id} className="card-link">
          <div className="cardList">
            ...
            <div className="card-content">
              <p className="card-price top-left">
                <FaDollarSign />
                {item.price}
              </p>
